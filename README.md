...
- Built Docker-based task environments, reference solutions, and deterministic `pytest` and shell verification suites.
- Reviewed AI-generated solutions for correctness, completeness, instruction following, regressions, and edge-case handling.
...
[![Live Demo](https://img.shields.io/badge/Live_Demo-2563EB?style=flat-square&logo=microsoftazure&logoColor=white)](https://campus-gate-app.azurewebsites.net)
[![Source Code](https://img.shields.io/badge/Source_Code-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/sameerreddy213/campus-gate)
...
![LLM Evaluation](https://img.shields.io/badge/LLM_Evaluation-6D28D9?style=flat-square)
